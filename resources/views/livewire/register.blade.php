    ...
    <div class="h-[100vh] w-[100%] xl:w-[50%] lg:w-[50%] md:w-[50%] sm:w-[100%] bg-color-secondary flex items-center justify-center overflow-auto overflow-y-scroll">
        <div class="flex flex-col items-center gap-3 w-[100%]">
            ...
            <form wire:submit.prevent="register" class="w-full flex flex-col items-center gap-3">
                @CSRF
                <x-input-field wire:model.defer="name" id="input-fields" label="Name" required/>
                <x-input-field wire:model.defer="email" id="input-fields" type="email" label="Email" required/>
                <x-input-field wire:model.defer="password" id="input-fields" type="password" label="Password" required/>
                <x-input-field wire:model.defer="password_confirmation" id="input-fields" type="password" label="Confirm Password" required/>

                <div class="flex w-[70%] xl:w-[50%] lg:w-[50%] md:w-[60%] sm:w-[70%]">
