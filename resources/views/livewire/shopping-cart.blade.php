<div>
    <div class="flex justify-center my-6">
        <div class="flex flex-col w-full bg-white shadow-lg p-3">
            <div class="flex-1">
                    ...
                    @foreach($items as $item)
                        <tr>
                            <td class="hidden pb-4 md:table-cell">
                                <a href="#">
                                    <img src="{{ asset('/storage/'.$item->item->image) }}" class="w-20 rounded" alt="Thumbnail" />
                                </a>
                            </td>
                            <td>
                                <p class="mb-2">{{ $item->item->name}}</p>
